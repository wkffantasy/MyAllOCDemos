...
@interface VideoRecordController ()<AVCaptureFileOutputRecordingDelegate>//视频文件输出代理
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = HEXRGBCOLOR(0x1d1e20);
    self.title = @"视频录制";
    ...
    preLayerHeight = ScreenWidth;
    preLayerHWRate =preLayerHeight/preLayerWidth;
    
    progressStep = ScreenWidth*TIMER_INTERVAL/totalTime;
...
-(void)initCapture{
    ...
    btView.center = CGPointMake(ScreenWidth/2, 64+preLayerHeight+20+43);
    [btView makeCornerRadius:43 borderColor:nil borderWidth:0];
    btView.backgroundColor = HEXRGBCOLOR(0xeeeeee);
    ...
    [shootBt makeCornerRadius:38 borderColor:HEXRGBCOLOR(0x28292b) borderWidth:3];
    [btView addSubview:shootBt];
    
    finishBt = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 60, 60)];
    finishBt.center = CGPointMake(ScreenWidth-35, 64+preLayerHeight+20+45);
    ...
    progressPreView.backgroundColor = HEXRGBCOLOR(0xffc738);
    [progressPreView makeCornerRadius:2 borderColor:nil borderWidth:0];
    [self.viewContainer addSubview:progressPreView];
    
    flashBt = [[UIButton alloc]initWithFrame:CGRectMake(ScreenWidth-90, 5, 34, 34)];
    ...
    cameraBt = [[UIButton alloc]initWithFrame:CGRectMake(ScreenWidth-40, 5, 34, 34)];
...
-(void)startTimer{
    shootBt.backgroundColor = HEXRGBCOLOR(0xf8ad6a);
